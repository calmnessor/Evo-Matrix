...
- [[Hi Robot]] — 分层 VLA 的开山之作，独立双 VLM 架构
- [[Hume]] — 价值引导的 System-2 推理 + 级联去噪 System-1
- [[π₀]] — PI 的 MoE 架构 + Flow Matching 基础
- [[RTC-实时动作分块]] — 推理时实时动作分块算法，可与 FiS 互补
- [[π₀.₅-KI]] — 知识绝缘防止联合训练中的梯度污染
- [[VLA模型总览]] — 其他 VLA 架构对比
